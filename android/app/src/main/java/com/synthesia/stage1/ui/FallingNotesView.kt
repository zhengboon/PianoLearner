...
// Slot rows stacked vertically. upcomingSlots[0] is the CURRENT slot (drawn at the bottom,
// just above the keyboard). Higher indices are further-future slots rendered higher up.
@Composable
